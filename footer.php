  ...
  <footer class="footer footer_type_1">
    <div class="footer-middle container">
        ...
        <div class="footer-column footer-store-info mb-4 mb-lg-0">
          <div class="logo">
            <a href="https://uomo-html.flexkitux.com/">
              <img src="<?php echo $bongotheme['header-logo']['url']; ?>" alt="Uomo" class="logo__image d-block" />
            </a>
          </div><!-- /.logo -->
         
          <?php echo $bongotheme['footer-desc'] ; ?>
      ...
      <?php
        ...
        $menu_id_3 = $locations['footer-menu-3']; 
        $menu_object = wp_get_nav_menu_object($menu_id); 
        $menu_object_2 = wp_get_nav_menu_object($menu_id_2); 
        $menu_object_3 = wp_get_nav_menu_object($menu_id_3); 
        $menu_name = $menu_object->name; 
        $menu_name_2 = $menu_object_2->name; 
        $menu_name_3 = $menu_object_3->name; 

      ?>
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          <h5 class="sub-menu__title text-uppercase"><?php echo $menu_name; ?></h5>
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          <h5 class="sub-menu__title text-uppercase"><?php echo $menu_name_2; ?></h5>
          <ul class="sub-menu__list list-unstyled">
              <?php
                wp_nav_menu( array(
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          <h5 class="sub-menu__title text-uppercase"><?php echo $menu_name_3; ?></h5>
          <ul class="sub-menu__list list-unstyled">
            <?php
                wp_nav_menu( array(
